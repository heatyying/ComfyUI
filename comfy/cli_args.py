...
parser.add_argument("--profile-output", type=str, default=None, metavar="PATH", help="Collect the next prompt with PyTorch Profiler and write a Chrome trace to PATH. Profiling is disabled by default and applies to one prompt only.")
